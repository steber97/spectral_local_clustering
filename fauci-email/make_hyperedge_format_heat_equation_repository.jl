...
open("../Hypergraph_clustering_based_on_PageRank/SubmodularHeatEquation/instance/fauci_email_no_cc_LCC.txt", "w") do f
...
# Create dataset with CC
kf = true  # Keep fauci
mindeg = 2
parts_cc = ("sender", "recipients", "cc")
H_cc = _build_email_hypergraph(data; hyperedgeparts=parts_cc, keepfauci=kf,  mindegree = mindeg)

open("../Hypergraph_clustering_based_on_PageRank/SubmodularHeatEquation/instance/fauci_email_cc_LCC.txt", "w") do f
